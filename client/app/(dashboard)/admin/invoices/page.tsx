...
const STATUS_COLORS: Record<string, string> = {
  DRAFT: 'bg-[#D8CFC2] text-[#4A3E34] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.5),inset_-2px_-2px_4px_rgba(255,255,255,0.8)] font-bold',
  SENT: 'bg-[#D8CFC2] text-[#EA580C] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.5),inset_-2px_-2px_4px_rgba(255,255,255,0.8)] font-bold',
  PAID: 'bg-[#D8CFC2] text-[#10B981] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.5),inset_-2px_-2px_4px_rgba(255,255,255,0.8)] font-bold',
  OVERDUE: 'bg-[#D8CFC2] text-[#EF4444] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.5),inset_-2px_-2px_4px_rgba(255,255,255,0.8)] font-bold',
  CANCELLED: 'bg-[#D8CFC2] text-[#4A3E34] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.5),inset_-2px_-2px_4px_rgba(255,255,255,0.8)] font-bold',
};
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button size="sm" onClick={() => setIsCreateDrawerOpen(true)} className="self-start sm:self-auto cursor-pointer rounded-2xl font-extrabold">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-24">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-[#4A3E34] font-extrabold">Loading invoices...</p>
            </div>
          </div>
        ) : error ? (
          <div className="text-center py-20 flex flex-col items-center gap-4">
            ...
            <div>
              <p className="font-extrabold text-[16px] text-[#EF4444]">Failed to load invoices</p>
          ...
          <div className="text-center py-16 px-6 bg-[#D8CFC2] rounded-3xl shadow-[inset_3px_3px_6px_rgba(135,120,108,0.4),inset_-3px_-3px_6px_rgba(255,255,255,0.85)] max-w-xl mx-auto my-6 flex flex-col items-center">
            <div className="h-16 w-16 rounded-full bg-[#D8CFC2] shadow-[inset_3px_3px_6px_rgba(135,120,108,0.5),inset_-3px_-3px_6px_rgba(255,255,255,0.85)] flex items-center justify-center mb-4">
              <FileSpreadsheet className="h-8 w-8 text-[#EA580C]" />
            </div>
            <h3 className="text-[18px] font-extrabold text-[#1F1610] mb-1">No invoices found</h3>
            <p className="text-[14px] text-[#4A3E34] mb-6 font-extrabold">Create an invoice to get started</p>
            <Button
