    ...
    <div className="space-y-8 bg-[#D8CFC2] text-[#1F1610] p-1">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <button
            ...
            className="h-10 px-4 font-bold text-[14px] text-[#1F1610] bg-[#D8CFC2] rounded-2xl flex items-center justify-center transition-all cursor-pointer shadow-[-4px_-4px_8px_rgba(255,255,255,0.75),4px_4px_8px_rgba(135,120,108,0.72)] hover:shadow-[-6px_-6px_12px_rgba(255,255,255,0.85),6px_6px_12px_rgba(125,110,98,0.8)] active:shadow-[inset_3px_3px_6px_rgba(135,120,108,0.7),inset_-3px_-3px_6px_rgba(255,255,255,0.72)]"
          >
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Total Projects</span>
          </div>
          <div>
            <div className="kpi-figure text-[38px] font-extrabold text-[#1F1610]">{metrics.totalProjects}</div>
            <p className="text-[12px] text-[#4A3E34] mt-1">All videos in system</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Active Projects</span>
          </div>
          <div>
            <div className="kpi-figure text-[38px] font-extrabold text-[#EA580C]">{metrics.activeProjects}</div>
            <p className="text-[12px] text-[#4A3E34] mt-1">Currently in edit pipeline</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Completed</span>
          </div>
          <div>
            <div className="kpi-figure text-[38px] font-extrabold text-[#10B981]">{metrics.completedProjects}</div>
            <p className="text-[12px] text-[#4A3E34] mt-1">Approved and delivered videos</p>
          </div>
        </div>
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Deadlines</span>
          </div>
          <div>
            <div className="kpi-figure text-[38px] font-extrabold text-[#EF4444]">{metrics.upcomingDeadlines}</div>
            <p className="text-[12px] text-[#4A3E34] mt-1">Due within next 7 days</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <Link href="/admin/financials" className="block transition-transform hover:-translate-y-1">
          <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
            <div>
              <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Net Profit</span>
            </div>
            <div>
              <div className="kpi-figure text-[38px] font-extrabold text-[#10B981]">{profitFormatted}</div>
              <p className="text-[12px] text-[#4A3E34] mt-1">Net operating margin (Click for Financials)</p>
            </div>
          </div>
        </Link>
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Pending Payments</span>
          </div>
          <div>
            ...
            <p className="text-[12px] text-[#4A3E34] mt-1">Invoices awaiting clearance</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] flex flex-col space-y-4">
          <div className="flex items-center justify-between border-b border-transparent pb-3">
            <div>
              <h3 className="text-[18px] font-extrabold text-[#1F1610] tracking-tight">
                Pending Revision Approvals
              </h3>
              <p className="text-[13px] text-[#4A3E34] mt-1">
                Client requested revisions waiting for your approval to be sent to editors.
              </p>
            </div>
            <div className="bg-[#D8CFC2] text-[#EF4444] px-4 py-1.5 rounded-2xl font-extrabold text-xs shadow-[inset_2px_2px_5px_rgba(135,120,108,0.7),inset_-2px_-2px_5px_rgba(255,255,255,0.72)]">
          ...
          <div className="flex-1">
            {metrics.pendingRevisionsCount === 0 ? (
              <div className="flex flex-col items-center justify-center text-center p-8 bg-[#D8CFC2] rounded-2xl shadow-[inset_3px_3px_6px_rgba(135,120,108,0.7),inset_-3px_-3px_6px_rgba(255,255,255,0.72)]">
                <div className="h-10 w-10 rounded-full bg-[#D8CFC2] flex items-center justify-center mb-2 text-[#10B981] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.65),inset_-2px_-2px_4px_rgba(255,255,255,0.72)]">
                  <CheckCircle2 className="h-5 w-5" />
                </div>
                <p className="text-[15px] font-extrabold text-[#1F1610]">All caught up!</p>
                <p className="text-[13px] text-[#4A3E34] max-w-sm mt-1">
              ...
              <div className="space-y-3">
                {metrics.pendingRevisions.map((project: any) => {
                  ...
                  return (
                    <div key={pendingReq.id} className="p-4 bg-[#D8CFC2] rounded-2xl shadow-[inset_3px_3px_6px_rgba(135,120,108,0.7),inset_-3px_-3px_6px_rgba(255,255,255,0.72)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-extrabold text-[#1F1610]">{project.title}</span>
                          <span className="text-[10px] font-extrabold px-2.5 py-0.5 rounded-xl bg-[#D8CFC2] text-[#EF4444] shadow-[inset_2px_2px_4px_rgba(135,120,108,0.65),inset_-2px_-2px_4px_rgba(255,255,255,0.72)]">
                            {project.status.replace(/_/g, ' ')}
                          </span>
                        </div>
                        <div className="text-xs text-[#4A3E34]">
                          Client: <span className="font-bold text-[#1F1610]">{project.client?.company || project.client?.user?.name || 'Unknown'}</span>
                      ...
                      <div className="flex items-center gap-3">
                        <button 
                          ...
                          className="px-4 py-2 bg-gradient-to-br from-[#10B981] to-[#059669] text-white font-bold text-xs rounded-xl shadow-[-3px_-3px_6px_rgba(255,255,255,0.6),3px_3px_8px_rgba(16,185,129,0.45)] hover:shadow-[-4px_-4px_8px_rgba(255,255,255,0.7),4px_4px_10px_rgba(16,185,129,0.55)] transition-all cursor-pointer flex items-center"
                        >
                        ...
                        <button 
                          ...
                          className="px-4 py-2 bg-[#D8CFC2] text-[#EF4444] font-bold text-xs rounded-xl shadow-[-3px_-3px_6px_rgba(255,255,255,0.75),3px_3px_6px_rgba(135,120,108,0.7)] active:shadow-[inset_2px_2px_4px_rgba(135,120,108,0.7),inset_-2px_-2px_4px_rgba(255,255,255,0.72)] transition-all cursor-pointer flex items-center"
                        >
        ...
        <div className="p-6 bg-[#D8CFC2] rounded-3xl shadow-[-8px_-8px_16px_rgba(255,255,255,0.75),8px_8px_16px_rgba(135,120,108,0.75)] hover:shadow-[-10px_-10px_20px_rgba(255,255,255,0.85),10px_10px_20px_rgba(125,110,98,0.85)] transition-all space-y-4">
          <div>
            <span className="text-[12px] font-extrabold uppercase tracking-wider text-[#4A3E34]">Other / Unassigned</span>
          </div>
          <div>
            <div className="kpi-figure text-[38px] font-extrabold text-[#1F1610]">{metrics.otherProjects}</div>
            <p className="text-[12px] text-[#4A3E34] mt-1">Cancelled or unassigned projects</p>
          </div>
        </div>
      </div>
    </div>
