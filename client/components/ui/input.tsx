    ...
    return (
      <div className="w-full">
        <input
          type={type}
          className={cn(
            'flex h-11 w-full rounded-2xl border-0 bg-[#D8CFC2] text-[#1F1610] font-semibold px-4 py-2 text-sm placeholder:text-[#4A3E34] focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
